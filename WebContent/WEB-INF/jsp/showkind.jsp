...
<body>
    ...
    <table class="tablelist">
    	<thead>
	        ...
	        <th>商品种类</th>
	        <th>种类描述<i class="sort"><img src="../images/px.gif" /></i></th>
	        <th>创建时间</th>
	        <th>创建人</th>
	        <th>操作</th>
	        </tr>
        ...
        <tbody>
        <c:forEach items="${tbkind}" var="tbkind">
	        <tr>
	        <td><input name="" type="checkbox" value="" /></td>
	        <td>${tbkind.kindName}</td>
	        <td>${tbkind.kindDesc}</td>
	        <td><fmt:formatDate value="${tbkind.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
	        <td>${tbkind.createUser}</td>
